...
$msg="This email already associated with another account";
    ...
    //$email = "abhishekpandita18@gmail.com";
    //$name = "Abhishek";
    $body = "Hey man, You have just signedup to our portal.WELCOME TO ERMS.";
    $subject = "ERMS Signup";

    $headers = array(
        'Authorization: Bearer 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',
